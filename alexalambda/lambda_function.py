...
"""
# added ability to use client ssl authentication
# by kbowman@newedenconsultinggroup.com
...
# Note - if using lambda, the path is /var/task/<CLIENT_CRT_FILE>
    client_crt = os.environ.get('CLIENT_CRT')
    assert base_url is not None, 'Please set CLIENT_CRT file name'
